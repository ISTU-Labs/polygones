...
namespace Main
{
    public partial class Lab3 : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "figuresDataSet5.Rectangles". При необходимости она может быть перемещена или удалена.
            this.rectanglesTableAdapter2.Fill(this.figuresDataSet5.Rectangles);
            // TODO: данная строка кода позволяет загрузить данные в таблицу "figuresDataSet4.Polygons". При необходимости она может быть перемещена или удалена.
            this.polygonsTableAdapter1.Fill(this.figuresDataSet4.Polygons);
            // TODO: данная строка кода позволяет загрузить данные в таблицу "figuresDataSet3.Rectangles". При необходимости она может быть перемещена или удалена.
            this.rectanglesTableAdapter1.Fill(this.figuresDataSet3.Rectangles);
            ...
            string connectionString = @"Data Source=PC2\SQLEXPRESS;Initial Catalog=Figures;Integrated Security=True";
